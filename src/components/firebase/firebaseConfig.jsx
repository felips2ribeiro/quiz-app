...
import { getFirestore, collection, addDoc, getDocs, where, query, doc, updateDoc } from 'firebase/firestore';
...
export { db, collection, addDoc, getDocs, where, query, doc, updateDoc };
