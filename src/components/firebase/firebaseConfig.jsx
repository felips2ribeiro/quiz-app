...
import { getFirestore, collection, addDoc, getDocs, getDoc, where, query, doc, updateDoc, deleteDoc } from 'firebase/firestore';
...
export { db, collection, addDoc, getDocs,getDoc, where, query, doc, updateDoc, deleteDoc };
